...
namespace Gestion.EF.Migrations
{
    ...
    [Migration("20201124145227_ParteDiario_Asitencia2")]
    partial class ParteDiario_Asitencia2
    {
            ...
            modelBuilder.Entity("Gestion.EF.Models.Contratistas", b =>
                {
                    ...
                    b.Property<int?>("ParteDiario_AsistenciaId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ParteDiario_AsistenciaId");
            ...
            modelBuilder.Entity("Gestion.EF.Models.Contratistas", b =>
                {
                    ...
                    b.HasOne("Gestion.EF.Models.ParteDiario_Asistencia", null)
                        .WithMany("Contratistas")
                        .HasForeignKey("ParteDiario_AsistenciaId");
            ...
            modelBuilder.Entity("Gestion.EF.Models.Incidentes", b =>
                {
                    b.HasOne("Gestion.EF.Models.ParteDiario_Incidentes", null)
                        .WithMany("Incidentes")
                        .HasForeignKey("ParteDiario_IncidentesId");
                });

            modelBuilder.Entity("Gestion.EF.Models.IncidentesTipo", b =>
                {
                    b.HasOne("Gestion.EF.Models.Incidentes", null)
                        .WithMany("IncidentesTipo")
