#pragma checksum "/Users/leandrolisa/Projects/082023_PuchetaWEB_test/Gestion.Web/Views/Planificacion/Plan_de_Avance_Rubro.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "9d228ed85d1348e022a56feabaaf58c0592fc910"
// <auto-generated/>
#pragma warning disable 1591
[assembly: global::Microsoft.AspNetCore.Razor.Hosting.RazorCompiledItemAttribute(typeof(AspNetCore.Views_Planificacion_Plan_de_Avance_Rubro), @"mvc.1.0.view", @"/Views/Planificacion/Plan_de_Avance_Rubro.cshtml")]
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"9d228ed85d1348e022a56feabaaf58c0592fc910", @"/Views/Planificacion/Plan_de_Avance_Rubro.cshtml")]
    ...
    #nullable restore
    public class Views_Planificacion_Plan_de_Avance_Rubro : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<Res_Gantt>
    #nullable disable
    {
        ...
        {
#nullable restore
#line 2 "/Users/leandrolisa/Projects/082023_PuchetaWEB_test/Gestion.Web/Views/Planificacion/Plan_de_Avance_Rubro.cshtml"
...
#nullable restore
#line 67 "/Users/leandrolisa/Projects/082023_PuchetaWEB_test/Gestion.Web/Views/Planificacion/Plan_de_Avance_Rubro.cshtml"
...
#nullable disable
      ...
      ");
                WriteLiteral(@"      var lPPA_Dependencias = oData.lPPA_Dependencias;
   ...
   ");
        ...
        function cambiarTitulo(data) {
            ...
            titulo += ""<span title='Dias de diferencia entre Fec. Prog. Fin y Fec. Est. Fin' style='margin-left:0.5em; color: "" +
                (data.diasDiferencia > 0 ? 'red' : (d");
                WriteLiteral(@"ata.diasDiferencia == 0 ? 'blue' : 'green')) + ""'> "" +
        ...
        function cambiarApariencia(data) {
            ...
            contenidoNuevo += ""<input");
                WriteLiteral(@" id='inpFecHasta' type='date' style='width:16%; height: 1.9em; font-size:0.8em; line-height:normal'/>"";
            ...
            for (var i = 0; i < lCeldas.length; i++) {
                ...
                if (celda.innerH");
                WriteLiteral(@"TML.includes(""***En Curso***"")) {
        ...
        function getToolTip(e) {
            ...
            var ff_mm = String(e.ta");
                WriteLiteral(@"sk.end.getMonth() + 1).padStart(2, '0');
            ...
            template += ""Actividad: <st");
                WriteLiteral(@"rong>"" + e.task.actividades_nombre + ""</strong><br />"";
        ...
        function getDataGant() {
            ...
            oFiltro = {
                ...
                lId");
                WriteLiteral(@"sProyUbicaciones: lUbicaciones.map(u => u.id),
    ...
    ");
        ...
        function scrollAFechaActual(gantt) {
            ...
            if (idTaskToScroll == 0) {
                ...
                var i = 0;
                while (i < oData.lAvances.length && oData.");
                WriteLiteral(@"lAvances[i].id != idTaskToScroll) {
                    i++;
                }
    ...
    ");
        ...
        function getSelectUbicaciones(lUbicaciones) {
            ...
            var options = '<option value=""0"" ' + (IdUbicacionSeleccionada == 0 ");
                WriteLiteral(@"? 'selected' : '') + '>Ubicación</option>';
        ...
        function getSelectBusqueda(lBusqueda) {
            var select = '<select id=""slcBusqueda"" style=""width:16%; height:1.6em;"" ' +
                'onchang");
                WriteLiteral(@"e=""seleccionarBusqueda()"">#options</select>';
            var options = """";
            lBusqueda.forEach(e => {
       ...
       ");
                WriteLiteral(@"             lOpcionesFiltro.push({ id: seleccion, tipo: 'ubicacion', nombre: ubicacion.nombre })
                }
            }
            renderTagsOpciones();
        }
        ...
        function seleccionarBusqueda() {
            const seleccion");
                WriteLiteral(@" = slcBusqueda.value;
        ...
        function eliminaracciones() {
            ...
            const resizehandle = document");
                WriteLiteral(@".getElementsByClassName(""k-resize-handle"");
