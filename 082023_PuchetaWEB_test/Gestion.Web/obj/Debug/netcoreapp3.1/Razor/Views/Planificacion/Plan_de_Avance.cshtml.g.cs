#pragma checksum "/Users/leandrolisa/Projects/082023_PuchetaWEB_test/Gestion.Web/Views/Planificacion/Plan_de_Avance.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "1b3344e164990cbf028b70f375b8fe88ecb57f34"
// <auto-generated/>
#pragma warning disable 1591
[assembly: global::Microsoft.AspNetCore.Razor.Hosting.RazorCompiledItemAttribute(typeof(AspNetCore.Views_Planificacion_Plan_de_Avance), @"mvc.1.0.view", @"/Views/Planificacion/Plan_de_Avance.cshtml")]
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"1b3344e164990cbf028b70f375b8fe88ecb57f34", @"/Views/Planificacion/Plan_de_Avance.cshtml")]
    ...
    #nullable restore
    public class Views_Planificacion_Plan_de_Avance : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<Res_Gantt>
    #nullable disable
    {
        ...
        {
#nullable restore
#line 2 "/Users/leandrolisa/Projects/082023_PuchetaWEB_test/Gestion.Web/Views/Planificacion/Plan_de_Avance.cshtml"
...
<script id=""editor"" type=""text/x-kendo-template"">
    ...
    <table width=""98%"">
        <tbody>
            ...
            WriteLiteral(@"<label>Padres:</label></td>
                <td>
                    <div id=""divActPadres"" style=""padding-left:5px""></span>
                </td>
            </tr>
            <tr>
                <td style=""text-align:right; width: 30%""><label>Hijas:</label></td>
                <td>
                    <div id=""divActHijas"" style=""padding-left:5px""></span>
                </td>
            </tr>
            <tr>
                <td style=""text-align:right; width: 30%""><label>Fecha Real Inicio:</label></td>
                <td>
                    <span id=""spnFecInicioReal"" style=""padding-left:5px""></span>
                </td>
            </tr>
            <tr>
                <td style=""text-align:right; width: 25%""><label>Fecha Real Fin:</label></td>
                <td>
                    <span id=""spnFecFinReal"" style=""padding-left:5px""></span>
                </td>
            </tr>
            <tr>
                <td style=""text-align:right; width: 25%""><label>Avance:</labe");
            WriteLiteral(@"l></td>
                <td>
                    <span id=""spnPorcAvances"" style=""padding-left:5px""></span>
                </td>
            </tr>
            <tr>
                <td style=""text-align:right; width: 25%""><label>Título:</label></td>
                <td>
                    <span id=""spnTitle"" style=""padding-left:5px""></span>
                </td>
            </tr>
            <tr>
                <td style=""text-align:right; width: 25%""><label>Comentario:</label></td>
                <td>
                    <p id=""pComentario"" style=""padding-left:5px""></p>
                </td>
            </tr>
            <tr>
                <td style=""text-align:right""><label>Inicio:</label></td>
                <td>
                    <input data-role=""datetimepicker"" data-format=""dd/MM/yyyy hh:mm"" name=""start"" />
                </td>
            </tr>
            <tr>
                <td style=""text-align:right""><label>Fin:</label></td>
                <td>
                 ");
            WriteLiteral(@"   <input data-role=""datetimepicker"" data-format=""dd/MM/yyyy hh:mm"" name=""end"" />
                </td>
            </tr>
        </tbody>
    </table>
...
");
    ...
    <script>
        ...
        let oData = JSON.parse(JSON.stringifyEscaped(");
#nullable restore
#line 135 "/Users/leandrolisa/Projects/082023_PuchetaWEB_test/Gestion.Web/Views/Planificacion/Plan_de_Avance.cshtml"
...
#nullable disable
            ...
            $(""#Gantt"").kendoGantt({
                ...
                views: [
                    ...
                    },
                    {
                        type: ""day"",
                   ");
                WriteLiteral(@"     dayHeaderTemplate: kendo.template(""#=kendo.toString(start, 'ddd dd.MM.yyyy')#"")
                    },
                ],
                columns: [
                    { field: ""estado"", title: ""Estado"", width: 60 },
                    { field: ""type"", title: ""Planificacion"", width: 80, },
                    { field: ""title"", title: ""Ubicacion - Actividad"", width: 260, },
                ...
                pdf: {
                  ");
                WriteLiteral(@"  fileName: ""Gantt.pdf"",
                },
                columnMenu: true,
                filterable: true,
                reorderable: true,
                ...
                messages: {
                    deleteTaskWindowTitle: ""Eliminar"",
                    deleteTaskConfirmation: ""¿Realmente desea eliminar la tarea?"",
                },
                add: function (e) {
                    if (e.dependency) {
                        if (e.dependency.type == 1) {
                            grabarDependencia(e.dependency);
                        }
                ...
                WriteLiteral(@"edit: function (e) {
                    if (e.task.type == 'Real') {
                        ...
                        setTimeout(function () {
                            var divActPadres = document.getElementById(""divActPadres"");
                            divActPadres.innerHTML = e.task.detalleActPadres;
                            var divActHijas = document.getElementById(""divActHijas"");
                            divActHijas.innerHTML = e.task.detalleActHijas;
                            var fecInicioReal = document.getElementById(""spnFecInicioReal"");
                            fecInicioReal.innerHTML = e.task.fecInicioReal;
                            var fecFinReal = document.getElementById(""spnFecFinReal"");
                            fecFinReal.innerHTML = e.task.fecFinReal;
                            var spnPorcAvances = document.getElementById(""spnPorcAvan");
                WriteLiteral(@"ces"");
                            spnPorcAvances.innerHTML = e.task.avance;
                            var spnTitle = document.getElementById(""spnTitle"");
                            spnTitle.innerHTML = e.task.title;
                            var pComentario = document.getElementById(""pComentario"");
                            pComentario.innerHTML = e.task.comentario ? e.task.comentario : 'Sin comentario registrado.';
                            var btnBorrar = document.getElementsByClassName(""k-gantt-delete"");
                            btnBorrar[0].style = ""display: none"";
                        }, 200);
                    }
                },
                remove: function (e) {
                    if (e.dependencies.length > 0) {
                        borrarDependencia(e.dependencies[0]);
                    }
                    else {
                ...
                resizeStart: function (e) {
                    ...
                    if (e.task.estado.includes(""Finalizada"")) {
                        e.preventDefault();
                        return;
                    }
                    startRevert = e.task.start;
                    endRevert = e.task.end;
                },
                resizeEnd: function (e) {
                    if (e.start != startRevert && e.task.avance > 0) {
                        e.preventDefault();
                    }
                },
       ...
       ");
        ...
        function cambiarTitulo(data) {
            ...
            titulo += ""<span title='Dias de diferencia entre Fec. Prog. Fin y Fec. Est. Fin' style='margin-left:0.5em; color: "" +
                (data.diasDiferencia > 0 ? 'red' : (data.diasDiferencia == 0 ? 'blue");
                WriteLiteral(@"' : 'green')) + ""'> "" +
        ...
        function cambiarApariencia(data) {
            ...
            contenidoNuevo += ""<input id='inpFecHasta' type='date' s");
                WriteLiteral(@"tyle='width:16%; height: 1.9em; font-size:0.8em; line-height:normal'/>"";
            contenidoNuevo += getSelectUbicaciones(data.lUbicaciones);
            contenidoNuevo += getSelectActividades(data.lActividades);
        ...
        function getToolTip(e) {
            ...
            var ff_mm = String(e.task.end.getMonth() + 1).padS");
            ...
            template += ""Actividad: <strong>"" + e.task.actividades");
                WriteLiteral(@"_nombre + ""</strong><br />"";
        ...
        function getDataGant() {
            ...
            let lActividades = lOpcionesFiltro.filter(o => o.tipo == 'actividad');
            ...
            oFiltro = {
                ...
                lIdsProyUbicaciones: lUbic");
                WriteLiteral(@"aciones.map(u => u.id),
                lIdsPlanActividades: lActividades.map(a => a.id),
            ...
            console.log(oFiltro);
            $.post(""/Planificacion/GetAvances"", oFiltro).done(
                function (res) {
                    if (!res.error) {
     ...
     ");
        ...
        function colorearTareas(gantt) {
            gantt.element.find("".k-task"").each(function (e) {
                ...
                if (dataItem.fechaEstInicio == dataItem.fechaEstInicioOriginal &&
                    ...
                    else if (dataItem.estado.includes(""E");
                WriteLiteral(@"n Curso"")) {
        ...
        function scrollAFechaActual(gantt) {
            ...
            if (idTaskToScroll == 0) {
                ...
                view.content.scrollLeft(left);
  ");
                WriteLiteral(@"              view.content.scrollTop(view._rowHeight * (i-5));
            }
        }
  ...
  ");
                WriteLiteral(@"                  html = html + ""<td style='text-align:center'></td>"";
                    html = html + ""</tr>"";
                }
                html = html + ""</tbody>"";
                html = html + ""</table>"";
        ...
        function grabarCambios(e) {
            var fecha_Inicio = """";
            var fecha_Fin = """";
            console.log(""Grabando cambios..."");
            var fecInicio = e.values.start ? e.values.start : e.task.start;
            var fecFin = e.values.end ? e.values.end : e.task.end;
            fecha_Inicio = fecInicio.getUTCFullYear() + ""-"" + (fecInicio.getUTCMonth() + 1) + ""-"" + fecInicio.getUTCDate();
            fecha_Fin = fecFin.getUTCFullYear() + ""-"" + (fecFin.getUTCMonth() + 1) + ""-"" + fecFin.getUTCDate();
            var oPlanProyActividad = {
                id: e.task.id,
                idProyecto: oData");
                WriteLiteral(@".idProyecto,
                fecha_Est_Incio: fecha_Inicio,
                fecha_Est_Fin: fecha_Fin
            };
            var revertirCambio = function (e) {
                e.task.set('start', startRevert);
                e.task.set('end', endRevert);
                e.sender.dataSource.sync();
            };
            $.post(""/Planificacion/ActualizarPlanProyActividad"", oPlanProyActividad).done(
                function (res) {
                    if (!res.error) {
                        if (res.oResult.cambioAplicable) {
                            console.log(""Cambio grabado con éxito."");
                            oData.fecEstimadaFin = res.fecEstimadaFin;
                            cambiarTitulo(oData);
                            idTaskToScroll = oPlanProyActividad.id;
                            if (res.oResult.lPlanProyActividades_Resultante.length > 1) {
                                getDataGant();
                            }
                        }
           ");
                WriteLiteral(@"             else {
                            toastr.error(res.oResult.message, { timeOut: 2000 });
                            revertirCambio(e);
                        }
                    }
                    else {
                        toastr.error(res.message, { timeOut: 2000 });
                        if (res.ex) console.log(""Error: "" + res.ex);
                        revertirCambio(e);
                    }
                }
            );
        ...
        function grabarDependencia(d) {
            var oDependencia = {
                Id: d.id,
                PPAHijaId: d.successorId,
                PPAPadreId: d.predecessorId
            };
            $.post(""/Planificacion/AgregarDepedencia"", oDependencia).done(
                function (res) {
                    if (!res.error) {
                        console.log(res.message);
                    }
                    else {
                        alert(""Ocurrió un error! Si el problema persiste, contact");
                WriteLiteral(@"e con el administrador."");
                        console.log(""Error: "" + res.message);
                    }
                }
            );
        ...
        function borrarDependencia(d) {
            var oDependencia = {
                PPAHijaId: d.successorId,
                PPAPadreId: d.predecessorId
            };
            $.post(""/Planificacion/BorrarDepedencia"", oDependencia).done(
                function (res) {
                    if (!res.error) {
                        console.log(res.message);
                    }
        ...
        function getSelectActividades(lActividades) {
            var select = '<select");
                WriteLiteral(@" id=""slcActividades"" style=""width:16%; height:1.6em;"" ' +
                'onchange=""seleccionarActividad()"">#options</select>';
            var options = '<option value=""0"" ' + (IdActividadSeleccionada == 0 ? 'selected' : '') + '>Actividad</option>';
            lActividades.forEach(a => {
                options += '<option value=""' + a.id + '"" ' + (IdActividadSeleccionada == a.id ? 'selected' : '') + '>' + a.nombre + '</option>';
            });
        ...
        function getSelectUbicaciones(lUbicaciones) {
            ...
            lUbicaciones.forEach(u => {
                options += '<option value=""' + u.id + '""' + (IdUbicacionSelecciona");
                WriteLiteral(@"da == u.id ? 'selected' : '') + '>' + u.nombre + '</option>';
            });
            select = select.replace(""options"", options);
            return select;
        }
        ...
        function seleccionarActividad() {
            const seleccion = slcActividades.value;
            IdActividadSeleccionada = seleccion;
            if (seleccion == 0) {
                lActividadesSeleccionadas = [];
                lOpcionesFiltro = lOpcionesFiltro.filter(o => o.tipo != 'actividad');
            }");
                WriteLiteral(@"
            else {
                let actividadYaSeleccionada = lActividadesSeleccionadas.find(a => a.id == seleccion);
                if (!actividadYaSeleccionada) {
                    lActividadesSeleccionadas.push(seleccion);
                    const actividad = oData.lActividades.find(a => a.id == seleccion);
                    lOpcionesFiltro.push({ id: seleccion, tipo: 'actividad', nombre: actividad.nombre })
                }
            }
            renderTagsOpciones();
        }
      ...
      ");
                WriteLiteral(@"              lUbicacionesSeleccionadas.push(seleccion);
        ...
        function eliminarOpcion(index) {
            lOpcionesFiltro = lOpcionesFiltro.filter(o => o.index != index);
            renderTagsOpciones();
        }
...
");
        ...
        #nullable restore
        [global::Microsoft.AspNetCore.Mvc.Razor.Internal.RazorInjectAttribute]
        public global::Microsoft.AspNetCore.Mvc.Rendering.IHtmlHelper<Res_Gantt> Html { get; private set; } = default!;
        #nullable disable
    }
}
