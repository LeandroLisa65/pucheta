#pragma checksum "/Users/leandrolisa/Projects/082023_PuchetaWEB_test/Gestion.Web/Views/ParteDiario/_ParteDiarioResumen.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "8bbb9c710214d3b073001772d078d95f5e228bdf"
// <auto-generated/>
#pragma warning disable 1591
[assembly: global::Microsoft.AspNetCore.Razor.Hosting.RazorCompiledItemAttribute(typeof(AspNetCore.Views_ParteDiario__ParteDiarioResumen), @"mvc.1.0.view", @"/Views/ParteDiario/_ParteDiarioResumen.cshtml")]
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"8bbb9c710214d3b073001772d078d95f5e228bdf", @"/Views/ParteDiario/_ParteDiarioResumen.cshtml")]
    ...
    #nullable restore
    public class Views_ParteDiario__ParteDiarioResumen : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<Res_PD_Resumen>
    #nullable disable
    {
...
#nullable restore
#line 177 "/Users/leandrolisa/Projects/082023_PuchetaWEB_test/Gestion.Web/Views/ParteDiario/_ParteDiarioResumen.cshtml"
...
#nullable disable
    ...
    function gril");
        ...
        lActContratistas.forEach(ac => {
            ...
            if (lItemsCalidadValoracion.length > 0) {
                ...
                lItemsCalidadValoracion.forEach(icv => {
                    ...
                    if (lItemsCalida");
            WriteLiteral(@"dValoracion.length > contador)
                        templateToolTip += ""<hr/>"";
                });
            }
            else {
        ...
        colGrilla.");
            WriteLiteral(@"push({ title: ""Avance"", media: ""(min-width: 450px)"", template: "" # {# <strong>Avance Acum:</strong> ${avance} <br> <strong>Cant Acum:</strong> ${cantidadAcumulada} #} #"" });
        ...
        $(""#grillaActividades"").kendoGrid({
            ...
            dataBound: function () {
                ...
                for (var i = 0; i < dataView.length; i++) {
                    ...
                    if");
            WriteLiteral(@" (dataView[i].colorFondo == ""V"") {
                        var uid = dataView[i].uid;
    ...
    function grillaAsistencia(datos) {
        ...
        colGrilla.push({ field: ""asig_Presentes"", title: ""Presentes"", medi");
            WriteLiteral(@"a: ""(min-width: 450px)"" });
    ...
    function grillaIncidentes(datos) {
        ...
        colGrilla.push({ field: ""sComentario"", title: ""Comentario"", media: ""(min-width: 450px)"" });
        colGrilla.push({ field: ""sSolicitadoPor"", title: ""Solicitado Por"", media: ""(min-width: 450");
            WriteLiteral(@"px)"" });
    ...
    function grillaIncidentesHistorial(datos) {
        ...
        $(""#grillaIncide");
            WriteLiteral(@"ntesHistorial"").kendoGrid({
            filterable: true,
            sortable: true,
            filterable: true,
            groupable: true,
    ...
    function grillaCalidadObra(datos) {
        ...
        colGrilla.push({ title: """", width: ""70px"", template: '# if (sCalidadItemCompleto) {#<button type=""button"" class=""btn btn-secondary"" data-toggle=""tooltip"" data-placement=""top"" title=""(#=sCalidadItemCompleto#)""><i");
            WriteLiteral(@" class=""fa fa-info-circle"" aria-hidden=""true""></i></button>#} else {##}#', });
        ...
        $(""#grillaCalidadObra"").kendoGrid({
            ...
            dataBound: function () {
                ...
                for (var i = 0; i < dataView.length; i++) {
      ");
            WriteLiteral(@"              if (dataView[i].sValor == ""No Paso"") {
                        var uid = dataView[i].uid;
    ...
    function getArchivos(e) {
            ...
            $.get(""");
#nullable restore
#line 418 "/Users/leandrolisa/Projects/082023_PuchetaWEB_test/Gestion.Web/Views/ParteDiario/_ParteDiarioResumen.cshtml"
              Write(Url.Action("ParteDiarioArchivosContratistas2", "ParteDiario"));
...
#nullable disable
    ...
    function getArchivosIncidentes(e) {
         var dataItem = this.dataItem($(e.currentTarget).closest(""tr""));
         var id = data");
            WriteLiteral("Item.parteDiario_IncidentesId;\r\n            $.get(\"");
#nullable restore
#line 442 "/Users/leandrolisa/Projects/082023_PuchetaWEB_test/Gestion.Web/Views/ParteDiario/_ParteDiarioResumen.cshtml"
...
#nullable disable
    ...
    function deleteFile(id) {
        $.get(""");
#nullable restore
#line 489 "/Users/leandrolisa/Projects/082023_PuchetaWEB_test/Gestion.Web/Views/ParteDiario/_ParteDiarioResumen.cshtml"
