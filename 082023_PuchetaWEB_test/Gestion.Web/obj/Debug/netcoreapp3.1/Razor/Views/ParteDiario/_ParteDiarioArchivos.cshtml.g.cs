#pragma checksum "/Users/leandrolisa/Projects/082023_PuchetaWEB_test/Gestion.Web/Views/ParteDiario/_ParteDiarioArchivos.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "ed30d311fe5ef948f1a7eb23846684c0da015a37"
// <auto-generated/>
#pragma warning disable 1591
[assembly: global::Microsoft.AspNetCore.Razor.Hosting.RazorCompiledItemAttribute(typeof(AspNetCore.Views_ParteDiario__ParteDiarioArchivos), @"mvc.1.0.view", @"/Views/ParteDiario/_ParteDiarioArchivos.cshtml")]
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"ed30d311fe5ef948f1a7eb23846684c0da015a37", @"/Views/ParteDiario/_ParteDiarioArchivos.cshtml")]
    ...
    #nullable restore
    public class Views_ParteDiario__ParteDiarioArchivos : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<List<Gestion.EF.Models.Archivos_Adjuntos_Relacion>>
    #nullable disable
    {
    ...
    <script>
        ...
        var data = JSON.parse('");
#nullable restore
#line 13 "/Users/leandrolisa/Projects/082023_PuchetaWEB_test/Gestion.Web/Views/ParteDiario/_ParteDiarioArchivos.cshtml"
...
#nullable disable
            ...
            for (var i = 0; i < data.length; i++) {
                if (data[i].archivos_Adjuntos.extencion == ""PNG"" ||
                    ...
                    htmlD = htmlD + ""<div id='Img_"" + data[i].archivos_AdjuntosId +
                        ...
                        ""' style='width:100%; height:auto;'/> </a>"" + data[i].archivos_Adjuntos.extencion +
                        ""<br>"" + data[i].archivos_Adjuntos.sUsuario +
                        "" <img onclick='deleteFile("" + data[i].archivos_AdjuntosId +
                        "")' src='../dist/img/deleteImage.png' style='floa");
            WriteLiteral(@"t:right; padding:5px; width:30px; height:auto;' /> </div>"";
                } else {
                    htmlD = htmlD + ""<div id='Img_"" + data[i].archivos_AdjuntosId +
                        ""' class='col-md-3'><a href='"" + data[i].archivos_Adjuntos.url +
                        data[i].archivos_Adjuntos.archivo + ""' target='_blank'>"" +
                        data[i].archivos_Adjuntos.archivo + ""<br>"" + data[i].archivos_Adjuntos.extencion +
                        ""<br>"" + data[i].archivos_Adjuntos.sUsuario +
        ...
        function deleteFile(id) {
            $.get(""");
#nullable restore
#line 45 "/Users/leandrolisa/Projects/082023_PuchetaWEB_test/Gestion.Web/Views/ParteDiario/_ParteDiarioArchivos.cshtml"
