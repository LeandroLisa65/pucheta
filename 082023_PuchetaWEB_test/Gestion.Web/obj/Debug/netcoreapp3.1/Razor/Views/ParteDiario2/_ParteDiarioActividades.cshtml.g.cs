#pragma checksum "/Users/leandrolisa/Projects/082023_PuchetaWEB_test/Gestion.Web/Views/ParteDiario2/_ParteDiarioActividades.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "4c3dafcd30be03eeeec39dc3dcf7a15b1173026f"
// <auto-generated/>
#pragma warning disable 1591
[assembly: global::Microsoft.AspNetCore.Razor.Hosting.RazorCompiledItemAttribute(typeof(AspNetCore.Views_ParteDiario2__ParteDiarioActividades), @"mvc.1.0.view", @"/Views/ParteDiario2/_ParteDiarioActividades.cshtml")]
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"4c3dafcd30be03eeeec39dc3dcf7a15b1173026f", @"/Views/ParteDiario2/_ParteDiarioActividades.cshtml")]
    ...
    #nullable restore
    public class Views_ParteDiario2__ParteDiarioActividades : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<Gestion.EF.ReturnData>
    #nullable disable
    {
            ...
            <div class=""card-body"">
                <div class=""row d-flex justify-content"">
                    ...
                    <div class=""col-md-2"">
                        <div class=""form-group"">
 ");
            WriteLiteral(@"                           <label class=""control-label"">Trabajo Hoy:</label>
                    ...
                    <div class=""col-md-2"">
                        <button type=""button"" class=""btn btn-outline-dark float-right""
                                style=""float:right;""
        ");
            WriteLiteral(@"                        onclick=""_BuscarFiltroGrillaActividad()"">
...
<script type=""text/x-kendo-template"" id=""Grid-Btn-template2"">
    <div>  #= trabajo ? '<img src=""../dist/img/checkbox.png"" />' : '<img src=""../dist/img/uncheckbox.png"" />");
            WriteLiteral(@"' # </div>
</script>
...
<script>
    ...
    var data = JSON.parse('");
#nullable restore
#line 79 "/Users/leandrolisa/Projects/082023_PuchetaWEB_test/Gestion.Web/Views/ParteDiario2/_ParteDiarioActividades.cshtml"
...
#nullable disable
    ...
    async function grabarDatoGrillaAsync(e) {
        ...
        var model = {
            ...
            FinalizadaActividadNP: d.finalizadaActivid");
            WriteLiteral(@"adNP,
                       ...
                       //No tiene item asociados, disparamos el update (hay otro llamado en la funcion MostrarItensCalidadAsync)
                        $.post(""/Partediario2/Update_PDActividades"", model).done(function (e) {
                            if (!e.isError) {
                             ...
                             ");
            WriteLiteral(@"   grillaActividades(dataGlobal);
                            }
                        });
                 }else{
    ...
    //#region CombosSinOrdenar
        ...
        function grillaActividades(lstActividades) {
                ...
                schema: {
                    model: {
                        ...
                        fields: {
                            ...
                            sUbicacion: { editab");
            WriteLiteral(@"le: false, nullable: false },
            ...
            colGrilla.push({field: ""sUbicacion"", title: ""Ubicacion"", me");
            WriteLiteral(@"dia: ""(min-width: 300px)"" });
            ...
            WriteLiteral(@"table: true,
                dataBound: function () {
                    ...
                    for (var i = 0; i < dataView.length; i++) {
                        ...
                        if (dataView[i].");
            WriteLiteral(@"finalizadaActividadNP) {
                            var uid = dataView[i].uid;
...
");
    ...
    //
    // Funcion que se enc");
            WriteLiteral(@"arga de buscar el listado de Actividades para este Proyecto
    //
    ...
    //
    // Funcion que se encarga de cargar los filtros ");
            WriteLiteral(@"de Avance para este Proyecto para hoy
    //   
    ...
    function cargarComboFiltroAEstado() {
        $(""#filtroParteDiarioGril");
            WriteLiteral(@"laEstado"").kendoDropDownList({
            filter: ""contains"",
            dataTextField: ""nombre"",
            dataValueField: ""id"",
    ...
    async function cambiarFormatoLista(listaChange){
        ...
        listaChange.forEach((item) => {
          ...
          ");
            WriteLiteral(@"          nuevoObjeto[clave.replace(/\s/g, ""_"")] = valor.trim();
                }
   ...
   async function mostrarItemsCalidadAsync(lista, model) {
        ...
        // Recorremos la lista
        lista");
            WriteLiteral(@"MostrarItems.forEach((objeto, index) => {
            ...
            contenido += `
                            ...
                            <p style=""text-align: left; margin: 5px 0;""><strong>CON ELEMENTO:</strong> ${obj");
            WriteLiteral(@"eto.CON_ELEMENTO}</p>
                            ...
                            <div class=""row"">
                                <div class=""col-md-12"">
                                    <input type=""file""
                                               ");
            WriteLiteral(@"   id=""inpFUAbmItemsCalidad""
        ...
        const result = await Swal.fire({
            ...
            preConfirm: () => {
                ...
                listaMostrarItems.forEach((objeto, index) => {
                    // Obtenemos los val");
            WriteLiteral(@"ores seleccionados y las observaciones de cada objeto
                    ...
                    if (opcionSeleccionada === '2' && observaciones.trim() === '') {
                        ...
                        listaObjetosGuardados.push({
                            ...
                            Valor: opcionSeleccionada === '2'? ""N"": ""S"",");
            WriteLiteral(@"      //Se aprobo o no se aprobo
        ...
        if (result.isConfirmed) {
            ...
            //Aca disparamos el guar");
            WriteLiteral(@"dar de Nuevo con la lista de Items!
                ...
                if (res.error) {
                    ...
                    res.lArchivosAdjuntos.forEach(aa => {
                         const imagenConCalidad = {
                             IdCalidad: idCalidad,
                                ImagenId: aa.ar");
            WriteLiteral(@"chivos_AdjuntosId
                        };
