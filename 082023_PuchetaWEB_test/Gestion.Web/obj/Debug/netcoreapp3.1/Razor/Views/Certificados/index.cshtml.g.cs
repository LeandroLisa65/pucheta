#pragma checksum "/Users/leandrolisa/Projects/082023_PuchetaWEB_test/Gestion.Web/Views/Certificados/index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "d4fb6e8dc6465e55f5bee86b0cbc1f05554ece8d"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"d4fb6e8dc6465e55f5bee86b0cbc1f05554ece8d", @"/Views/Certificados/index.cshtml")]
    ...
    #nullable restore
    public class Views_Certificados_index : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<object>
    #nullable disable
    {
        ...
        {
#nullable restore
#line 2 "/Users/leandrolisa/Projects/082023_PuchetaWEB_test/Gestion.Web/Views/Certificados/index.cshtml"
...
#line hidden
#nullable disable
            WriteLiteral(@"<div id=""ContenidoGeneralCertificado"" class=""row"">
    <div class=""col-lg-12"">
        <div class=""card  card-rojo"">
            ...
            EndWriteAttribute();
            WriteLiteral(@" onclick=""GenerarCertificado()"">
            ...
            WriteLiteral(@"       <div class=""col-md-2"">
                    ...
                    <div class=""col-md-1.5"" style=""padding-left:18px; padding-right:10px;"">
                        <div class=""form-group"">
                            ...
                            <input id=""cerFiltroFecHasta"" type=""date"" class=""form-control"" style=""width: 100%;"" co");
            WriteLiteral(@"ntenteditable=""false"" />
                        </div>
                    </div>
                    <div class=""col-md-2"">
                        <div class=""form-group"">
...
#nullable restore
#line 84 "/Users/leandrolisa/Projects/082023_PuchetaWEB_test/Gestion.Web/Views/Certificados/index.cshtml"
...
/*-------------------------CARGAR COMBOS---------------------------*/
        ...
        function cargaContratistasEncabezado(idProyecto=0) {
            if (idProyect");
                ...
                $.get(""");
#nullable restore
#line 120 "/Users/leandrolisa/Projects/082023_PuchetaWEB_test/Gestion.Web/Views/Certificados/index.cshtml"
                  Write(Url.Action("GetContratistasxCertificado", "Certificados"));
...
#nullable disable
  ...
  ");
                WriteLiteral(@"          cargaContratistasEncabezado(idProyecto);
        };
        /*--------*/
        ...
        function cargaContratistas() {
                $.get(""");
#nullable restore
#line 164 "/Users/leandrolisa/Projects/082023_PuchetaWEB_test/Gestion.Web/Views/Certificados/index.cshtml"
                  Write(Url.Action("GetContratistas_En_Certificado", "Certificados"));
...
/*-------------------------CRUD--------------------------*/
        ...
        function GenerarCertificado()
        {
            ...
            var selectedValueProyecto = $(");
                WriteLiteral(@"'#cerProyectosEnc').val();
...
#nullable restore
#line 225 "/Users/leandrolisa/Projects/082023_PuchetaWEB_test/Gestion.Web/Views/Certificados/index.cshtml"
               Write(Url.Action("_CertificadosAbm","Certificados"));

#line default
#line hidden
#nullable disable
                WriteLiteral(@"?IdProyecto="" + $('#cerProyectosEnc').val() + ""&IdContratista="" + $('#cerContratistasEnc').val() + ""&Modo="" + Modo,
                function (e) {
...
/*-------------------------GRILLA--------------------------*/
        function CargoGrilla_Certificados(datos) {
            ...
            $(""#grillaNP"").kendoGrid({
                ...
                columns: [
                    ...
                    { field");
                WriteLiteral(@": ""sProyecto"", title: ""Proyecto"", width: ""40px"" },
     ...
     ");
                ...
                dataBound: function () {
                    ...
                    for (var i = 0; i < dataView.length; i++) {
                        ...
                        if (dataView[i].estado == ""Abierto"") {
                            var uid = dataView[i].uid;
                            $(""#grillaNP tbody"").find(""tr[data-uid="" + uid + ""]"").addC");
                WriteLiteral(@"lass(""K-bacgraundRow_Z"");
                        }
        ...
        function buscarFiltroGrilla() {          
            ...
            console.log(model);
            $.post(""");
                WriteLiteral(@"/Certificados/CertificadoGrillaFiltro"", model).done(function (e) {
            if (!e.isError) {
        ...
        function VerCertificado(e) {
            ...
            $.post(""");
#nullable restore
#line 316 "/Users/leandrolisa/Projects/082023_PuchetaWEB_test/Gestion.Web/Views/Certificados/index.cshtml"
               Write(Url.Action("_CertificadosAbm","Certificados"));

#line default
#line hidden
#nullable disable
                WriteLiteral(@"?IdCertificado="" + dataItem.id + ""&Modo="" + 'Lectura',
                function (e) {
                    $('#ContenidoGeneralCertificado').html(e);
        ...
        function EliminarCertificado(e) {
            ...
            $.post(""/Certificados/EliminarCertificados/"" + dataItem.id)
                .done(function (e) {
                    if (!e.isError) {
        ");
                WriteLiteral(@"                toastr.success('Se elimino correctamente el Certificado.', { timeOut: 2000 });
                        CargoGrilla_Certificados(e.data2);
                    }
                    else {
                        if(e.data3 != """")
      ...
      ");
            ...
            $.post(""");
#nullable restore
#line 371 "/Users/leandrolisa/Projects/082023_PuchetaWEB_test/Gestion.Web/Views/Certificados/index.cshtml"
               Write(Url.Action("_CertificadosAbm","Certificados"));

#line default
#line hidden
#nullable disable
                WriteLiteral(@"?IdCertificado="" + dataItem.id + ""&Modo="" + dataItem.estado,
                function (e) {
                    $('#ContenidoGeneralCertificado').html(e);
