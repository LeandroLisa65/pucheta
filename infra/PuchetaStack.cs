...
class PuchetaStack : Stack {
    ...
    public PuchetaStack() {
        ...
        var image = new Docker.Image("app-pucheta", new()
        {
        ...
        // var image = new Docker.Image("app-pucheta", new Docker.ImageArgs
        // {
        //     Build = "../src",
        //     ImageName = appRepo.RepositoryUrl,
        //     Registry = new Input<RegistryArgs>()
